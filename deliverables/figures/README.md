...
| 2 · What we did | `fig_slide2_pipeline.png` + `fig_slide2_scatter.png` | pipeline (Madrid -> line-up x2 -> predict, 0.36 -> 0.65) and the before/after: Madrid's cloud moves onto Amsterdam's after the line-up |
